...
const QUANTI_CONFIGS: CostConfig[] = [
  { key: 'custo_plataforma_survey', label: 'Plataforma de Survey', description: 'Custo fixo por projeto', value: null },
  { key: 'custo_elaboracao_instrumento', label: 'Elaboracao do Instrumento', description: 'Custo fixo', value: null },
  { key: 'custo_analise_entregavel', label: 'Analise e Entregavel', description: 'Custo fixo', value: null },
  { key: 'custo_analytics_avancado', label: 'Analytics Avancado', description: 'Custo adicional', value: null },
];

const QUALI_CONFIGS: CostConfig[] = [
  { key: 'custo_aluguel_sala', label: 'Aluguel de Sala', description: 'Por sessao', value: null },
  { key: 'custo_moderacao_sessao', label: 'Moderacao', description: 'Por sessao', value: null },
  { key: 'custo_recrutamento_participante', label: 'Recrutamento', description: 'Por participante', value: null },
  { key: 'custo_incentivo_participante', label: 'Incentivo', description: 'Por participante', value: null },
  { key: 'custo_transcricao_hora', label: 'Transcricao', description: 'Por hora', value: null },
  { key: 'custo_elaboracao_roteiro', label: 'Elaboracao de Roteiro', description: 'Custo fixo', value: null },
  { key: 'custo_analise_qualitativa', label: 'Analise Qualitativa', description: 'Custo fixo', value: null },
];
