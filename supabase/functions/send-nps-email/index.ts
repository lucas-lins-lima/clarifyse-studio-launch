...
serve(async (req) => {
  ...
  try {
    ...
    const { project_id, project_name } = await req.json() as NPSEmailRequest;
    ...
    // Get all NPS responses for this project that haven't been sent yet
        ...
        try {
          const emailResponse = await fetch("https://api.resend.com/emails", {
            ...
            body: JSON.stringify({
              ...
              to: [client.email],
              subject: `Avalie seu projeto: ${project_name}`,
              html: `
                <!DOCTYPE html>
                <html>
                <head>
                ...
                <body>
                  <div class="container">
                    ...
                    <div class="content">
                      <p>Ola, ${client.name}!</p>
                      <p>O projeto <strong>${project_name}</strong> foi concluido e gostaríamos muito de saber sua opiniao sobre a experiencia com a Clarifyse.</p>
